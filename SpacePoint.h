...
// Mon Nov 18 14:05:36 2019 by ROOT version 6.14/06
// from TTree anatree/analysis tree
// found on file: MainFile.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[141];   //[nclus]
   Double_t        clusterttick[141];   //[nclus]
   Double_t        cluendwire[141];   //[nclus]
   Double_t        cluendtick[141];   //[nclus]
   Int_t           cluplane[141];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[33];   //[ntracks_reco]
   Double_t        trkvtxy[33];   //[ntracks_reco]
   Double_t        trkvtxz[33];   //[ntracks_reco]
   Double_t        trkendx[33];   //[ntracks_reco]
   Double_t        trkendy[33];   //[ntracks_reco]
   Double_t        trkendz[33];   //[ntracks_reco]
   Double_t        trkstartdcosx[33];   //[ntracks_reco]
   Double_t        trkstartdcosy[33];   //[ntracks_reco]
   Double_t        trkstartdcosz[33];   //[ntracks_reco]
   Double_t        trkenddcosx[33];   //[ntracks_reco]
   Double_t        trkenddcosy[33];   //[ntracks_reco]
   Double_t        trkenddcosz[33];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[33];   //[ntracks_reco]
   Double_t        trklength[33];   //[ntracks_reco]
   Double_t        trkmomrange[33];   //[ntracks_reco]
   Double_t        trkmommschi2[33];   //[ntracks_reco]
   Double_t        trkmommsllhd[33];   //[ntracks_reco]
   Int_t           ntrkhits[33];   //[ntracks_reco]
   Double_t        trkx[33][1000];   //[ntracks_reco]
   Double_t        trky[33][1000];   //[ntracks_reco]
   Double_t        trkz[33][1000];   //[ntracks_reco]
   Double_t        trkpitch[33][2];   //[ntracks_reco]
   Int_t           trkhits[33][2];   //[ntracks_reco]
   Double_t        trkdedx[33][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[33][2][1000];   //[ntracks_reco]
   Double_t        trkrr[33][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[33][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[33][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[33][2];   //[ntracks_reco]
   Double_t        trkpida[33][2];   //[ntracks_reco]
   Int_t           nTrajPoint[33];   //[ntracks_reco]
   Double_t        pHat0_X[33][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[33][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[33][1000];   //[ntracks_reco]
   Double_t        trjPt_X[33][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[33][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[33][1000];   //[ntracks_reco]
   Int_t           trkg4id[33];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[2591];   //[nhits]
   Int_t           hit_wire[2591];   //[nhits]
   Int_t           hit_channel[2591];   //[nhits]
   Double_t        hit_peakT[2591];   //[nhits]
   Double_t        hit_charge[2591];   //[nhits]
   Double_t        hit_ph[2591];   //[nhits]
   Double_t        hit_tstart[2591];   //[nhits]
   Double_t        hit_tend[2591];   //[nhits]
   Int_t           hit_trkid[2591];   //[nhits]
   Int_t           hit_trkkey[2591];   //[nhits]
   Int_t           hit_clukey[2591];   //[nhits]
   Int_t           hit_pk[2591];   //[nhits]
   Int_t           hit_t[2591];   //[nhits]
   Int_t           hit_ch[2591];   //[nhits]
   Int_t           hit_fwhh[2591];   //[nhits]
   Double_t        hit_rms[2591];   //[nhits]
   Double_t        hit_nelec[2591];   //[nhits]
   Double_t        hit_energy[2591];   //[nhits]
   Float_t         hit_dQds[2591];   //[nhits]
   Float_t         hit_dEds[2591];   //[nhits]
   Float_t         hit_ds[2591];   //[nhits]
   Float_t         hit_resrange[2591];   //[nhits]
   Float_t         hit_x[2591];   //[nhits]
   Float_t         hit_y[2591];   //[nhits]
   Float_t         hit_z[2591];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2987];   //[maxTrackIDE]
   Double_t        IDEPos[2987][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[2371];   //[geant_list_size]
   Double_t        Eng[2371];   //[geant_list_size]
   Double_t        Px[2371];   //[geant_list_size]
   Double_t        Py[2371];   //[geant_list_size]
   Double_t        Pz[2371];   //[geant_list_size]
   Double_t        EndEng[2371];   //[geant_list_size]
   Double_t        EndPx[2371];   //[geant_list_size]
   Double_t        EndPy[2371];   //[geant_list_size]
   Double_t        EndPz[2371];   //[geant_list_size]
   Double_t        StartPointx[2371];   //[geant_list_size]
   Double_t        StartPointy[2371];   //[geant_list_size]
   Double_t        StartPointz[2371];   //[geant_list_size]
   Double_t        EndPointx[2371];   //[geant_list_size]
   Double_t        EndPointy[2371];   //[geant_list_size]
   Double_t        EndPointz[2371];   //[geant_list_size]
   Int_t           Process[2371];   //[geant_list_size]
   Int_t           NumberDaughters[2371];   //[geant_list_size]
   Int_t           Mother[2371];   //[geant_list_size]
   Int_t           TrackId[2371];   //[geant_list_size]
   Int_t           process_primary[2371];   //[geant_list_size]
   vector<string>  *G4Process;
   vector<string>  *G4FinalProcess;
   Int_t           NTrTrajPts[7];   //[no_primaries]
   Double_t        MidPosX[7][5000];   //[no_primaries]
   Double_t        MidPosY[7][5000];   //[no_primaries]
   Double_t        MidPosZ[7][5000];   //[no_primaries]
   Double_t        MidPx[7][5000];   //[no_primaries]
   Double_t        MidPy[7][5000];   //[no_primaries]
   Double_t        MidPz[7][5000];   //[no_primaries]
   vector<int>     *InteractionPoint;
   vector<int>     *InteractionPointType;
   Int_t           no_mcshowers;
   Double_t        mcshwr_origin[15];   //[no_mcshowers]
   Double_t        mcshwr_pdg[15];   //[no_mcshowers]
   Int_t           mcshwr_TrackId[15];   //[no_mcshowers]
   Double_t        mcshwr_startX[15];   //[no_mcshowers]
   Double_t        mcshwr_startY[15];   //[no_mcshowers]
   Double_t        mcshwr_startZ[15];   //[no_mcshowers]
   Double_t        mcshwr_endX[15];   //[no_mcshowers]
   Double_t        mcshwr_endY[15];   //[no_mcshowers]
   Double_t        mcshwr_endZ[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngX[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngY[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngZ[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngPx[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngPy[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngPz[15];   //[no_mcshowers]
   Double_t        mcshwr_CombEngE[15];   //[no_mcshowers]
   Double_t        mcshwr_dEdx[15];   //[no_mcshowers]
   Double_t        mcshwr_StartDirX[15];   //[no_mcshowers]
   Double_t        mcshwr_StartDirY[15];   //[no_mcshowers]
   Double_t        mcshwr_StartDirZ[15];   //[no_mcshowers]
   Int_t           mcshwr_isEngDeposited[15];   //[no_mcshowers]
   Int_t           mcshwr_Motherpdg[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherTrkId[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherstartX[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherstartY[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherstartZ[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherendX[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherendY[15];   //[no_mcshowers]
   Int_t           mcshwr_MotherendZ[15];   //[no_mcshowers]
   Int_t           mcshwr_Ancestorpdg[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorTrkId[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorstartX[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorstartY[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorstartZ[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorendX[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorendY[15];   //[no_mcshowers]
   Int_t           mcshwr_AncestorendZ[15];   //[no_mcshowers]
   Int_t           nshowers;
...
#ifdef SpacePoint_cxx
SpacePoint::SpacePoint(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MainFile.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MainFile.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("MainFile.root:/anatree");
...
Int_t SpacePoint::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SpacePoint::LoadTree(Long64_t entry)
{
...
void SpacePoint::Init(TTree *tree)
{
...
void SpacePoint::Show(Long64_t entry)
{
...
Int_t SpacePoint::Cut(Long64_t entry)
{
